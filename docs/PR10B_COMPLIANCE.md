...
| --- | --- | --- | --- |
| R1 boundary-cross research-only mode | `src/ape/strategy/momentum_v2.py`, `src/ape/strategy/observer.py` | `tests/test_momentum_v2.py`, `tests/test_strategy_observer.py` | COMPLIANT |
| R2 first-book-only EXIT resolution | `src/ape/strategy/observer.py` | `tests/test_strategy_observer.py` | COMPLIANT |
